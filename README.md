...
This project for aims to develop a Tic Tac Toe game using typescript. It mainly consists of showcasing the basics of the language as well as how best to arrange the project.
